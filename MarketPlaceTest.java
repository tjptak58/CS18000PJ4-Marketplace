...
public class MarketPlaceTest {
    ...
    public void testTwo() {
        String input = "2" + System.lineSeparator() + "buyer" + System.lineSeparator() + "Jake" +
                System.lineSeparator() + "green" + System.lineSeparator() + "jake@gmail.com" + System.lineSeparator()
                + "purchaseHistory.txt" + System.lineSeparator() + "shoppingCart.txt" + System.lineSeparator() + "2"  + System.lineSeparator()
                + "Jake" + System.lineSeparator() + "Will" + System.lineSeparator() + "yellow" + System.lineSeparator()
                + "jake@gmail.com" + System.lineSeparator() + "purchaseHistory2.txt" + System.lineSeparator() + "shoppingCart2.txt" + System.lineSeparator()
                + "1" + System.lineSeparator() + "buyer" + System.lineSeparator() + "Jake" + System.lineSeparator()
                + "yellow" + System.lineSeparator() + "600" + System.lineSeparator() + "500" + System.lineSeparator()
                + "700" + System.lineSeparator() + "1000" + System.lineSeparator() + "350" + System.lineSeparator()
                + "550" + System.lineSeparator() + "550" + System.lineSeparator() + "850" + System.lineSeparator();
        ...
        String expected = "Welcome\n"
                ...
                + "What is the filepath to the shopping cart for this account?\n"
                + "Account made!\n"
                + "Would you like you login or create a new account?\n"
                + "1.Login\n"
                + "2.Create new account\n"
